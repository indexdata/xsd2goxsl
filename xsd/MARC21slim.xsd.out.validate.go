...
type CollectionType struct {
  Record []RecordType `xml:"record,omitempty" validate:"min=1,max=1,dive"`
  Id string `xml:"id,attr,omitempty"`
}

type RecordType struct {
  Leader *LeaderFieldType `xml:"leader,omitempty"`
  Controlfield []ControlFieldType `xml:"controlfield,omitempty" validate:"omitempty,dive"`
  Datafield []DataFieldType `xml:"datafield,omitempty" validate:"omitempty,dive"`
  Type string `xml:"type,attr,omitempty" validate:"omitempty,oneof=Bibliographic Authority Holdings Classification Community"`
  Id string `xml:"id,attr,omitempty"`
}
...
type DataFieldType struct {
  ...
  Subfield []SubfieldatafieldType `xml:"subfield,omitempty" validate:"min=1,max=1,dive"`
  Id string `xml:"id,attr,omitempty"`
  Tag string `xml:"tag,attr"`
