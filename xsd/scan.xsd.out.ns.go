...
type Diagnostics struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan diagnostics"`
  DiagnosticsDefinition
}

type DisplayTerm struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan displayTerm"`
  Text string `xml:",chardata"`
}

type ExtraResponseData struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan extraResponseData"`
  ExtraDataDefinition
}

type EchoedScanRequest struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan echoedScanRequest"`
  EchoedScanRequestDefinition
}

type ExtraRequestData struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan extraRequestData"`
  ExtraDataDefinition
}

type ExtraTermData struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan extraTermData"`
  ExtraDataDefinition
}

type HttpAccept struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan httpAccept"`
  Text string `xml:",chardata"`
}

type MaximumTerms struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan maximumTerms"`
  Text uint64 `xml:",chardata"`
}

type NumberOfRecords struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan numberOfRecords"`
  Text uint64 `xml:",chardata"`
}

type ResponsePosition struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan responsePosition"`
  Text uint64 `xml:",chardata"`
}

type RequestURL struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan requestURL"`
  Text string `xml:",chardata"`
}

type ScanClause struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan scanClause"`
  Text string `xml:",chardata"`
}

type Stylesheet struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan stylesheet"`
  Text string `xml:",chardata"`
}

type Terms struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan terms"`
  TermsDefinition
}

type Term struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan term"`
  TermDefinition
}

type Value struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan value"`
  Text string `xml:",chardata"`
}

type WhereInList struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan whereInList"`
  WhereInListDefinition
}

type XScanClause struct {
  XMLName xml.Name `xml:"http://docs.oasis-open.org/ns/search-ws/scan xScanClause"`
