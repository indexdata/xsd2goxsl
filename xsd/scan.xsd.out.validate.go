...
type EchoedScanRequestDefinition struct {
  ScanClause string `xml:"scanClause" validate:"required"`
...
type TermDefinition struct {
  ...
  WhereInList *WhereInListDefinition `xml:"whereInList,omitempty" validate:"omitempty,oneof=first last only inner"`
