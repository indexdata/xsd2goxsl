...
type PrefixesDefinition struct {
  Prefix []PrefixDefinition `xml:"prefix,omitempty" validate:"min=1,dive"`
}

type PrefixDefinition struct {
  Name string `xml:"name" validate:"required"`
  Identifier string `xml:"identifier" validate:"required"`
}
...
type SortKeysDefinition struct {
  Key []KeyDefinition `xml:"key,omitempty" validate:"min=1,dive"`
}

type BooleanPlusModifier struct {
  Value BooleanValue `xml:"value" validate:"required,oneof=and or not prox"`
...
type KeyDefinition struct {
  Index string `xml:"index" validate:"required"`
...
type ModifiersDefinition struct {
  Modifier []ModifierDefinition `xml:"modifier,omitempty" validate:"min=1,dive"`
}
