...
type ISO18626Message struct {
  ...
  Version utils.PrefixAttr `xml:"http://illtransactions.org/2013/iso18626 version,attr"`
}


type Request struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 request"`
...
type RequestConfirmation struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 requestConfirmation"`
...
type SupplyingAgencyMessage struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 supplyingAgencyMessage"`
...
type SupplyingAgencyMessageConfirmation struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 supplyingAgencyMessageConfirmation"`
  ConfirmationHeader ConfirmationHeader `xml:"confirmationHeader"`
...
type RequestingAgencyMessage struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 requestingAgencyMessage"`
...
type RequestingAgencyMessageConfirmation struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 requestingAgencyMessageConfirmation"`
  ConfirmationHeader ConfirmationHeader `xml:"confirmationHeader"`
...
type Action struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 action"`
  TypeAction
}


type Address struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 address"`
...
type BibliographicItemId struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 bibliographicItemId"`
...
type BibliographicInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 bibliographicInfo"`
...
type BibliographicRecordId struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 bibliographicRecordId"`
...
type BillingInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 billingInfo"`
...
type ConfirmationHeader struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 confirmationHeader"`
...
type ConsortialId struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 consortialId"`
  TypeAgencyId
}

type CourierName struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 courierName"`
  TypeSchemeValuePair
}


type DeliveryInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 deliveryInfo"`
...
type DeliveryMethod struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 deliveryMethod"`
  TypeSchemeValuePair
}

type Edition struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 edition"`
  Text string `xml:",chardata"`
}


type ElectronicAddress struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 electronicAddress"`
...
type ErrorData struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 errorData"`
  ErrorType TypeErrorType `xml:"errorType"`
  ErrorValue string `xml:"errorValue,omitempty"`
}

type ItemFormat struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 itemFormat"`
  TypeSchemeValuePair
}

type LoanCondition struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 loanCondition"`
  TypeSchemeValuePair
}


type MessageInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 messageInfo"`
...
type MultipleItemRequestId struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 multipleItemRequestId"`
  Text string `xml:",chardata"`
}


type PatronInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 patronInfo"`
...
type PaymentMethod struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 paymentMethod"`
  TypeSchemeValuePair
}


type PhysicalAddress struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 physicalAddress"`
...
type PublicationInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 publicationInfo"`
...
type RequestedDeliveryInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 requestedDeliveryInfo"`
...
type RequestingAgencyAuthentication struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 requestingAgencyAuthentication"`
  AccountId string `xml:"accountId,omitempty"`
  SecurityCode string `xml:"securityCode,omitempty"`
}

type RequestingAgencyId struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 requestingAgencyId"`
  TypeAgencyId
}


type RequestingAgencyInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 requestingAgencyInfo"`
...
type RequestingAgencyRequestId struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 requestingAgencyRequestId"`
  Text string `xml:",chardata"`
}


type ReturnInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 returnInfo"`
...
type RetryInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 retryInfo"`
  LoanCondition []TypeSchemeValuePair `xml:"loanCondition,omitempty"`
  Edition []string `xml:"edition,omitempty"`
  ItemFormat []TypeSchemeValuePair `xml:"itemFormat,omitempty"`
  Volume []string `xml:"volume,omitempty"`
...
type ServiceInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 serviceInfo"`
...
type ServiceLevel struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 serviceLevel"`
  TypeSchemeValuePair
}


type ShippingInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 shippingInfo"`
  CourierName *TypeSchemeValuePair `xml:"courierName,omitempty"`
...
type StatusInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 statusInfo"`
...
type SupplierInfo struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 supplierInfo"`
  SortOrder *SortOrder `xml:"sortOrder,omitempty"`
...
type SupplyingAgencyId struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 supplyingAgencyId"`
  TypeAgencyId
}
...
type SupplyingAgencyRequestId struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 supplyingAgencyRequestId"`
  Text string `xml:",chardata"`
}

type Timestamp struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 timestamp"`
  Text string `xml:",chardata"`
}

type TimestampReceived struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 timestampReceived"`
  Text string `xml:",chardata"`
}

type Volume struct {
  XMLName xml.Name `xml:"http://illtransactions.org/2013/iso18626 volume"`
  Text string `xml:",chardata"`
}
...
type TypeSchemeValuePair struct {
  Text string `xml:",chardata"`
  Scheme *utils.PrefixAttr `xml:"http://illtransactions.org/2013/iso18626 scheme,attr,omitempty"`
}
