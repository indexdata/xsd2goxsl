...
type Family struct {
  ...
  Children []Children `xml:"children,omitempty" validate:"min=1,dive"`
  FavChild struct {
  ...
  IncomeLevel IncomeLevel `xml:"incomeLevel" validate:"required,oneof=HIGH MEDIUM LOW"`
...
type Person struct {
  ...
  Gender Gender `xml:"gender" validate:"required,oneof=MALE FEMALE"`
...
type Children struct {
  ...
  Child []Person `xml:"child,omitempty" validate:"omitempty,dive"`
}
