...
type SearchResultAnalysisDefinition struct {
  ...
  SubqueryResult []SubqueryResultDefinition `xml:"subqueryResult,omitempty" validate:"min=1,dive"`
}
...
type DatasourceDefinition struct {
  ...
  Full string `xml:"full,attr,omitempty" validate:"omitempty,oneof=true"`
}
...
type SubqueryResultDefinition struct {
  ...
  Subquery string `xml:"subquery" validate:"required"`
...
type Subquery struct {
  XMLName xml.Name `xml:"subquery"`
  Text string `xml:",chardata"`
}

type SubqueryDisplayLabel struct {
  XMLName xml.Name `xml:"subqueryDisplayLabel"`
  Text string `xml:",chardata"`
}

type SubqueryResult struct {
  XMLName xml.Name `xml:"subqueryResult"`
  SubqueryResultDefinition
}

type SubqueryResults struct {
  XMLName xml.Name `xml:"subqueryResults"`
