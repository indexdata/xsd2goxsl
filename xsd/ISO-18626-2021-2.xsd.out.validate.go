...
type Request struct {
  ...
  SupplierInfo []SupplierInfo `xml:"supplierInfo,omitempty" validate:"omitempty,dive"`
  RequestedDeliveryInfo []RequestedDeliveryInfo `xml:"requestedDeliveryInfo,omitempty" validate:"omitempty,dive"`
...
type RequestConfirmation struct {
  ...
  ErrorData []ErrorData `xml:"errorData,omitempty" validate:"omitempty,dive"`
}
...
type SupplyingAgencyMessageConfirmation struct {
  ...
  ConfirmationHeader ConfirmationHeader `xml:"confirmationHeader"`
  ReasonForMessage *TypeReasonForMessage `xml:"reasonForMessage,omitempty" validate:"omitempty,oneof=RequestResponse StatusRequestResponse RenewResponse CancelResponse StatusChange Notification"`
  ErrorData []ErrorData `xml:"errorData,omitempty" validate:"omitempty,dive"`
}
...
type RequestingAgencyMessage struct {
  ...
  Action TypeAction `xml:"action" validate:"required,oneof=StatusRequest Received Cancel Renew HoldReturn ShippedReturn ShippedForward Notification Lost"`
...
type RequestingAgencyMessageConfirmation struct {
  ...
  ConfirmationHeader ConfirmationHeader `xml:"confirmationHeader"`
  Action *TypeAction `xml:"action,omitempty" validate:"omitempty,oneof=StatusRequest Received Cancel Renew HoldReturn ShippedReturn ShippedForward Notification Lost"`
  ErrorData []ErrorData `xml:"errorData,omitempty" validate:"omitempty,dive"`
}
...
type BibliographicInfo struct {
  ...
  BibliographicItemId []BibliographicItemId `xml:"bibliographicItemId,omitempty" validate:"omitempty,dive"`
...
type ConfirmationHeader struct {
  ...
  Timestamp string `xml:"timestamp" validate:"required"`
  RequestingAgencyRequestId string `xml:"requestingAgencyRequestId,omitempty"`
  TimestampReceived string `xml:"timestampReceived" validate:"required"`
  MessageStatus TypeMessageStatus `xml:"messageStatus" validate:"required,oneof=OK ERROR"`
}
...
type DeliveryInfo struct {
  ...
  LoanCondition []TypeSchemeValuePair `xml:"loanCondition,omitempty" validate:"omitempty,dive"`
  ItemFormat *TypeSchemeValuePair `xml:"itemFormat,omitempty"`
  ServiceType *TypeServiceType `xml:"serviceType,omitempty" validate:"omitempty,oneof=Copy Loan CopyOrLoan"`
  DeliveryCosts []TypeCosts `xml:"deliveryCosts,omitempty" validate:"omitempty,dive"`
  PaymentMethod *TypeSchemeValuePair `xml:"paymentMethod,omitempty"`
}
...
type ErrorData struct {
  ...
  ErrorType TypeErrorType `xml:"errorType" validate:"required,oneof=UnsupportedActionType UnsupportedReasonForMessageType UnrecognisedDataElement UnrecognisedDataValue BadlyFormedMessage"`
...
type MessageInfo struct {
  ...
  ReasonForMessage TypeReasonForMessage `xml:"reasonForMessage" validate:"required,oneof=RequestResponse StatusRequestResponse RenewResponse CancelResponse StatusChange Notification"`
  AnswerYesNo *TypeYesNo `xml:"answerYesNo,omitempty" validate:"omitempty,oneof=Y N"`
  Note string `xml:"note,omitempty"`
...
type PatronInfo struct {
  ...
  SendToPatron *TypeYesNo `xml:"sendToPatron,omitempty" validate:"omitempty,oneof=Y N"`
  Address []Address `xml:"address,omitempty" validate:"omitempty,dive"`
}
...
type TypeRequestHeader struct {
  ...
  Timestamp string `xml:"timestamp" validate:"required"`
  RequestingAgencyRequestId string `xml:"requestingAgencyRequestId" validate:"required"`
...
type RetryInfo struct {
  ...
  LoanCondition []TypeSchemeValuePair `xml:"loanCondition,omitempty" validate:"omitempty,dive"`
  Edition []string `xml:"edition,omitempty"`
  ItemFormat []TypeSchemeValuePair `xml:"itemFormat,omitempty" validate:"omitempty,dive"`
  Volume []string `xml:"volume,omitempty"`
  ServiceType *TypeServiceType `xml:"serviceType,omitempty" validate:"omitempty,oneof=Copy Loan CopyOrLoan"`
  ServiceLevel []TypeSchemeValuePair `xml:"serviceLevel,omitempty" validate:"omitempty,dive"`
  DeliveryMethod []TypeSchemeValuePair `xml:"deliveryMethod,omitempty" validate:"omitempty,dive"`
  CourierName []TypeSchemeValuePair `xml:"courierName,omitempty" validate:"omitempty,dive"`
  OfferedCosts []TypeCosts `xml:"offeredCosts,omitempty" validate:"omitempty,dive"`
  PaymentMethod []TypeSchemeValuePair `xml:"paymentMethod,omitempty" validate:"omitempty,dive"`
...
type ServiceInfo struct {
  ...
  RequestType *TypeRequestType `xml:"requestType,omitempty" validate:"omitempty,oneof=New Retry Reminder"`
  RequestSubType []TypeRequestSubType `xml:"requestSubType,omitempty" validate:"omitempty,dive,oneof=BookingRequest MultipleItemRequest PatronRequest TransferRequest SupplyingLibrarysChoice"`
  RequestingAgencyPreviousRequestId string `xml:"requestingAgencyPreviousRequestId,omitempty"`
  ServiceType TypeServiceType `xml:"serviceType" validate:"required,oneof=Copy Loan CopyOrLoan"`
  ...
  AnyEdition *TypeYesNo `xml:"anyEdition,omitempty" validate:"omitempty,oneof=Y N"`
  //  Deprecated 
  PreferredEdition *TypePreferredEdition `xml:"preferredEdition,omitempty" validate:"omitempty,oneof=MostRecentEdition ThisEdition AnyEdition"`
  //  Recommended 
  LoanCondition []TypeSchemeValuePair `xml:"loanCondition,omitempty" validate:"omitempty,dive"`
...
type ShippingInfo struct {
  ...
  Insurance *TypeYesNo `xml:"insurance,omitempty" validate:"omitempty,oneof=Y N"`
  InsuranceThirdParty *TypeYesNo `xml:"insuranceThirdParty,omitempty" validate:"omitempty,oneof=Y N"`
  ThirdPartyName string `xml:"thirdPartyName,omitempty"`
  InsuranceCosts []TypeCosts `xml:"insuranceCosts,omitempty" validate:"omitempty,dive"`
}
...
type StatusInfo struct {
  ...
  Status TypeStatus `xml:"status" validate:"required,oneof=RequestReceived ExpectToSupply WillSupply Loaned Overdue Recalled RetryPossible Unfilled HoldReturn ReleaseHoldReturn CopyCompleted LoanCompleted CompletedWithoutReturn Cancelled"`
  ExpectedDeliveryDate string `xml:"expectedDeliveryDate,omitempty"`
  DueDate string `xml:"dueDate,omitempty"`
  LastChange string `xml:"lastChange" validate:"required"`
}
...
type TypeAgencyId struct {
  ...
  AgencyIdValue string `xml:"agencyIdValue" validate:"required"`
}
